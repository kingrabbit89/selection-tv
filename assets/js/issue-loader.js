...
fetch(jsonUrl,{cache:'no-store'}).then(r=>{if(!r.ok)throw new Error('HTTP '+r.status);return r.json()}).then(async d=>{
 ...
 await addCss(root+'assets/css/'+(d.theme==='magazine'?'magazine.css?v=20260924-radarreserve':'archive.css?v=20260924-radarreserve'));
 ...
 await addScript(root+'assets/js/'+(d.theme==='magazine'?'magazine-week.js?v=20260924-radarreserve':'archive-week.js?v=20260924-radarreserve'));
 if(d.theme==='magazine'){
   await addScript(root+'assets/js/seen-filter.js?v=20260924-radarreserve');
   if(week==='2026-S40') await addScript(root+'assets/js/radar-data-s40.js?v=20260924-radarreserve');
   await addScript(root+'assets/js/radar-reserve.js?v=20260924-radarreserve');
 }
 await addScript(root+'assets/js/page-layout.js?v=20260924-radarreserve');
